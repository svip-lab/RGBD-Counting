...
def train_detector(model, dataset, cfg, distributed=False,
...
def _non_dist_train(model, dataset, cfg, validate=False):
    ...
    optimizer = build_optimizer(model, cfg.optimizer)  # torch.optim.Optimizer

    runner = Runner(model, batch_processor, optimizer, cfg, cfg.work_dir, cfg.log_level)
...
def build_optimizer(model, optimizer_cfg):
    ...
    Args:
        ...
        optimizer_cfg (dict): The config dict of the optimizer.
            ...
            Optional fields are:
                - any arguments of the corresponding optimizer type -
                  e.g., weight_decay, momentum, etc.
