...
class AnchorHead(nn.Module):
    ...
    """  # noqa: W605
    def __init__(self, num_classes, in_channels, feat_channels=256, anchor_scales=[8, 16, 32],
                 anchor_ratios=[0.5, 1.0, 2.0], anchor_strides=[4, 8, 16, 32, 64], anchor_base_sizes=None,
        ...
        self.anchor_base_sizes = list(  # anchor_strides -> anchor_base_sizes
        ...
        self.sampling = loss_cls['type'] not in ['FocalLoss', 'GHMC', 'CrossEntropyLoss']
    ...
    def forward(self, feats, densi_fea):
        return multi_apply(self.forward_single, feats, densi_fea)
